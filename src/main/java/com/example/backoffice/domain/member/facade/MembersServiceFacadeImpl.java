...
public class MembersServiceFacadeImpl implements MembersServiceFacade {
    ...
    public MembersResponseDto.CreateMembersResponseDto signup(
        ...
        if (duplicatedInfoMember != null) {
            ...
            switch (exceptionType) {
                case EMAIL -> throw new MembersCustomException(MembersExceptionCode.MATCHED_MEMBER_INFO_EMAIL);
                case ADDRESS -> throw new MembersCustomException(MembersExceptionCode.MATCHED_MEMBER_INFO_ADDRESS);
                case MEMBER_NAME ->
                        throw new MembersCustomException(MembersExceptionCode.MATCHED_MEMBER_INFO_MEMBER_NAME);
                case CONTACT -> throw new MembersCustomException(MembersExceptionCode.MATCHED_MEMBER_INFO_CONTACT);
                case NULL -> throw new MembersCustomException(MembersExceptionCode.NOT_FOUND_EXCEPTION_TYPE);
            }
        }
    ...
    public void updateRemainingVacationDays(
        ...
        switch (scheduledEventType) {
            ...
            default -> throw new SchedulerCustomException(GlobalExceptionCode.NOT_FOUND_SCHEDULER_EVENT_TYPE);
        }
    }
