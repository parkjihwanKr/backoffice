...
public enum NotificationType {
    ...
    UPCOMING_OUT_OFF_OFFICE_NOTIFICATION(Domain.UPCOMING_OUT_OFF_OFFICE_NOTIFICATION),
    ...
    public static class Domain {
        ...
        public static final String UPCOMING_OUT_OFF_OFFICE_NOTIFICATION = "UPCOMING_OUT_OFF_OFFICE_NOTIFICATION";
