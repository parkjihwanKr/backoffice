...
public enum EvaluationsExceptionCode {
    ...
    UNAUTHORIZED_DEPARTMENT_ACCESS(HttpStatus.FORBIDDEN, "EVALUATIONS-002", "해당 부서는 요청한 설문조사를 할 수 없습니다."),
    ...
    INCORRECT_DATE_QUARTER_REQUEST(HttpStatus.BAD_REQUEST, "EVALUATIONS-006", "요청하신 시작날의 분기와 마감일의 분기가 다릅니다."),
    ...
    UNAUTHORIZED_ACCESS(HttpStatus.FORBIDDEN,"EVALUATIONS-009","연간 설문 조사를 작성할 권한이 없습니다."),
    ...
    NOT_INPUT_EVALUATION_CHECKED(HttpStatus.FORBIDDEN,"EVALUATIONS-013","해당 설문조사에 체크를 해야 제출이 됩니다."),
    ;
